...
public class Test1App {
    ...
    private static final Logger log = LoggerFactory.getLogger(Test1App.class);

    private final Environment env;

    public Test1App(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(Test1App.class);
